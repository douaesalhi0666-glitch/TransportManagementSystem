...
namespace TransportManagementSystem.Migrations
{
    ...
    [Migration("20260519104837_AddAnomalyLogs")]
    partial class AddAnomalyLogs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TransportManagementSystem.Models.AnomalyLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AnomalyLog_tbl", "Service");
                });
            ...
            modelBuilder.Entity("TransportManagementSystem.Models.PersonnelBusAssignment", b =>
                {
                    b.Property<int>("PBA_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PBA_Id"));

                    b.Property<DateTime>("PBA_AssignedAt")
                        .HasColumnType("datetime2");

                    b.Property<long>("PBA_BusId")
                        .HasColumnType("bigint");

                    b.Property<long>("PBA_PersonnelId")
                        .HasColumnType("bigint");

                    b.Property<string>("PBA_Status")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<DateTime?>("PBA_UnassignedAt")
                        .HasColumnType("datetime2");

                    b.HasKey("PBA_Id");

                    b.HasIndex("PBA_BusId");

                    b.HasIndex("PBA_PersonnelId", "PBA_BusId", "PBA_Status")
                        .HasDatabaseName("IX_PBA_PersonnelBus_Status");

                    b.ToTable("PersonnelBusAssignment_tbl", "Assignment");
                });
            ...
            modelBuilder.Entity("TransportManagementSystem.Models.PersonnelBusAssignment", b =>
                {
                    b.HasOne("TransportManagementSystem.Models.Bus", "Bus")
                        .WithMany()
                        .HasForeignKey("PBA_BusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TransportManagementSystem.Models.Personnel", "Personnel")
                        .WithMany()
                        .HasForeignKey("PBA_PersonnelId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
